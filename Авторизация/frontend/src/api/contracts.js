 ...
 * @typedef {{query?:string, families?:ExchangerFamily[], manufacturerIds?:number[], applicationCodes?:string[], materialCodes?:string[], requiredSurfaceAreaM2?:number, requiredFlowM3h?:number, requiredPowerKw?:number, requiredTemperatureC?:number, requiredPressureBar?:number, page?:number, size?:number}} SearchRequest
 * @typedef {{id:number, slug:string, manufacturer:Manufacturer, model:string, seriesName?:string, family:ExchangerFamily, granularity:RecordGranularity, summary?:string, score:number, confidence?:string, completeness:number, reasons:string[], containsMockData:boolean, surfaceAreaM2?:number, flowMinM3h?:number, flowMaxM3h?:number, powerMinKw?:number, powerMaxKw?:number, temperatureMinC?:number, temperatureMaxC?:number, pressureMinBar?:number, pressureMaxBar?:number, widthMm?:number, heightMm?:number, depthMm?:number, massKg?:number, applications:LookupOption[], materials:LookupOption[]}} SearchItem
 ...
 * @typedef {{id:number, version:number, slug:string, manufacturer:Manufacturer, model:string, seriesName?:string, family:ExchangerFamily, granularity:RecordGranularity, status:PublicationStatus, summary?:string, surfaceAreaM2?:number, flowMinM3h?:number, flowMaxM3h?:number, powerMinKw?:number, powerMaxKw?:number, temperatureMinC?:number, temperatureMaxC?:number, pressureMinBar?:number, pressureMaxBar?:number, widthMm?:number, heightMm?:number, depthMm?:number, massKg?:number, applications:LookupOption[], materials:LookupOption[], facts:TechnicalFact[], sources:CatalogSource[], pressureLimits:PressureLimit[], containsMockData:boolean}} HeatExchangerDetail
 * @typedef {{version?:number, manufacturerId:number, slug:string, family:ExchangerFamily, model:string, seriesName?:string, granularity:RecordGranularity, status:PublicationStatus, summary?:string, applicationCodes:string[], materialCodes:string[], surfaceAreaM2?:number|null, flowMinM3h?:number|null, flowMaxM3h?:number|null, powerMinKw?:number|null, powerMaxKw?:number|null, temperatureMinC?:number|null, temperatureMaxC?:number|null, pressureMinBar?:number|null, pressureMaxBar?:number|null, widthMm?:number|null, heightMm?:number|null, depthMm?:number|null, massKg?:number|null, facts:TechnicalFact[], sources:CatalogSource[], pressureLimits:PressureLimit[]}} CatalogRecordInput
 */
